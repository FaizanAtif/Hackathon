...
export default function Caro2() {
    ...
    <div className="text-black h-auto w-full bg-[#ffff]">
      <div className="bg-[#1cb9d400]  w-[1044px] h-[651px] ml-52 flex justify-between gap-32">
            ...
            <button className="bg-[#2DC071] py-5 px-10 text-sm  font-bold text-white">SHOP NOW</button>
            <button className="border border-[#2dc071] py-5 px-10 text-sm font-bold text-[#2DC071]">READ MORE</button>
