...
export default function Desktop2() {
    return (
      <div className="h-auto w-full bg-[#FAFAFA] text-black">
        ...
        <Image src={pic1} alt=" pics1" height={500} width={510} />
        <Image src={pic2} alt="pics2" height={500} width={240} />
        
        <div className="flex-col  h-[500px] w-[240px]  ">
        <Image src={pic3} alt="pics3" height={242} width={240} />
        <Image src={pic4} alt=" pics4" height={242} width={240} className="mt-6" />
        </div>
        </div>
      </div>
    </div>
